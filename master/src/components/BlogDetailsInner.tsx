        ...
        <div className='row gy-4'>
          <div className='col-lg-8'>
            <div data-aos='fade-up' data-aos-duration={800}>
              ...
              <div className='tw-mt-10'>
                ...
                <div
                  className='bg-neutral-100 tw-py-9 tw-px-8'
                  data-aos='fade-up'
                ...
                <div
                  className='tw-my-11 d-flex justify-content-between flex-wrap tw-gap-6'
                  data-aos='fade-up'
                  data-aos-duration={800}
                >
                ...
                <div
                  className='bg-neutral-100 tw-py-16 tw-px-54-px'
                  data-aos='fade-up'
                  data-aos-duration={800}
                >
          ...
          <div className='col-lg-4 ps-xl-5 ps-lg-4'>
            ...
            <div className='d-flex flex-column tw-gap-8'>
              <div
                className='bg-neutral-100 tw-px-8 text-center tw-py-17'
                data-aos='fade-up'
                data-aos-duration={800}
              >
